...
const DB = {
  ...
  akses: [
    ...
    { no: 11, kapanewon: "Panjatan", sumber: "Dapodik & Dukcapil", apk: "77.5%", apm: "98.3% / 93.4%", ats: 168, putus: "0.14%", regrouping: "Optimal", statusColor: "emerald", usage: "Evaluasi Afirmasi Pesisir" },
    { no: 12, kapanewon: "Nanggulan", sumber: "Dapodik & BPS", apk: "78.1%", apm: "98.6% / 94.2%", ats: 152, putus: "0.11%", regrouping: "Optimal", statusColor: "emerald", usage: "Evaluasi Afirmasi Pertanian" }
  ],
  ...
  mutu: [
    ...
    { npsn: "20402845", nama: "SMP Negeri 1 Panjatan", kapanewon: "Panjatan", sumber: "Rapor Pendidikan Kemendikdasmen", literasi: "78.4 (Sedang)", numerasi: "74.2 (Sedang)", karakter: "80.1", akreditasi: "A (BAN-S/M)", pembinaan: "Pendampingan Reguler", statusColor: "emerald" },
    { npsn: "20402850", nama: "SMP Negeri 1 Nanggulan", kapanewon: "Nanggulan", sumber: "Rapor Pendidikan Kemendikdasmen", literasi: "79.5 (Sedang)", numerasi: "76.1 (Sedang)", karakter: "81.2", akreditasi: "A (BAN-S/M)", pembinaan: "Pendampingan Reguler", statusColor: "emerald" },
    { npsn: "20402855", nama: "SMP Negeri 1 Kalibawang", kapanewon: "Kalibawang", sumber: "Rapor Pendidikan Kemendikdasmen", literasi: "77.8 (Sedang)", numerasi: "73.5 (Sedang)", karakter: "79.4", akreditasi: "A (BAN-S/M)", pembinaan: "Pendampingan Intensif", statusColor: "amber" },
    { npsn: "20402860", nama: "SMP Negeri 1 Lendah", kapanewon: "Lendah", sumber: "Rapor Pendidikan Kemendikdasmen", literasi: "76.9 (Sedang)", numerasi: "72.8 (Sedang)", karakter: "78.9", akreditasi: "A (BAN-S/M)", pembinaan: "Pendampingan Intensif", statusColor: "amber" },
    { npsn: "20402865", nama: "SMP Negeri 1 Galur", kapanewon: "Galur", sumber: "Rapor Pendidikan Kemendikdasmen", literasi: "78.0 (Sedang)", numerasi: "74.0 (Sedang)", karakter: "80.5", akreditasi: "A (BAN-S/M)", pembinaan: "Pendampingan Reguler", statusColor: "emerald" }
  ],
  ...
  sarpras: [
    ...
    { npsn: "20402835", nama: "SMP Negeri 1 Temon", kapanewon: "Temon", sumber: "Dapodik Sarpras", baik: "14 Ruang", rusakRingan: "2 Ruang", rusakBerat: "0 Ruang", spm: "Sangat Layak", perpus: "Ada", lab: "Ada", dak: "Normal (Perawatan)", statusColor: "emerald" },
    { npsn: "20402830", nama: "SD Negeri Sentolo 1", kapanewon: "Sentolo", sumber: "Dapodik Sarpras", baik: "10 Ruang", rusakRingan: "2 Ruang", rusakBerat: "1 Ruang", spm: "Layak", perpus: "Ada", lab: "Ada", dak: "PRIORITAS 2 (REHAB)", statusColor: "amber" },
    { npsn: "20402855", nama: "SD Negeri Kalibawang 2", kapanewon: "Kalibawang", sumber: "Dapodik Sarpras", baik: "6 Ruang", rusakRingan: "3 Ruang", rusakBerat: "2 Ruang", spm: "Belum Layak", perpus: "Ada", lab: "Belum Ada", dak: "PRIORITAS 1 (MENDESAK)", statusColor: "red" },
    { npsn: "20402860", nama: "SD Negeri Lendah 1", kapanewon: "Lendah", sumber: "Dapodik Sarpras", baik: "8 Ruang", rusakRingan: "3 Ruang", rusakBerat: "1 Ruang", spm: "Layak", perpus: "Ada", lab: "Ada", dak: "PRIORITAS 2 (REHAB)", statusColor: "amber" },
    { npsn: "20402865", nama: "SD Negeri Galur 2", kapanewon: "Galur", sumber: "Dapodik Sarpras", baik: "7 Ruang", rusakRingan: "2 Ruang", rusakBerat: "1 Ruang", spm: "Layak", perpus: "Ada", lab: "Ada", dak: "PRIORITAS 2 (REHAB)", statusColor: "amber" },
    { npsn: "20402845", nama: "SD Negeri Panjatan 1", kapanewon: "Panjatan", sumber: "Dapodik Sarpras", baik: "9 Ruang", rusakRingan: "2 Ruang", rusakBerat: "0 Ruang", spm: "Layak", perpus: "Ada", lab: "Ada", dak: "Normal (Perawatan)", statusColor: "emerald" },
    { npsn: "20402850", nama: "SD Negeri Nanggulan 1", kapanewon: "Nanggulan", sumber: "Dapodik Sarpras", baik: "11 Ruang", rusakRingan: "1 Ruang", rusakBerat: "0 Ruang", spm: "Layak", perpus: "Ada", lab: "Ada", dak: "Normal (Perawatan)", statusColor: "emerald" }
  ],
  ...
  gtk: [
    ...
    { nip: "19780315 200501 1 005", nama: "Wahyu Hidayat, S.Pd", mapel: "PJOK", sumber: "BKPSDM & Dapodik", asal: "SDN 1 Galur (46 Thn)", jarakAsal: "16.4 km", tujuan: "SD Negeri Panjatan 1 (Defisit 1)", jarakBaru: "3.5 km", mcdmScore: "94.2%", argumentasi: "Pemerataan Guru PJOK Wilayah Selatan", statusColor: "emerald" },
    { nip: "19830520 200902 2 007", nama: "Nurul Hidayati, M.Pd", mapel: "Bahasa Indonesia", sumber: "BKPSDM & Info GTK", asal: "SMPN 1 Nanggulan (42 Thn)", jarakAsal: "14.8 km", tujuan: "SMP Negeri 1 Kalibawang (Defisit 1)", jarakBaru: "4.0 km", mcdmScore: "91.8%", argumentasi: "Efisiensi Jarak Guru Domisili Nanggulan", statusColor: "emerald" },
    { nip: "19871110 201101 1 009", nama: "Eko Prasetyo, S.Pd", mapel: "Bimbingan Konseling", sumber: "BKPSDM & Dapodik", asal: "SMPN 2 Lendah (38 Thn)", jarakAsal: "18.0 km", tujuan: "SMP Negeri 1 Sentolo (Defisit 1)", jarakBaru: "4.8 km", mcdmScore: "90.6%", argumentasi: "Pemenuhan Layanan BK Sekolah Rujukan", statusColor: "emerald" }
  ],
  ...
  kelembagaan: [
    ...
    { npsn: "69954012", nama: "PAUD KB Tunas Bangsa Kokap", kapanewon: "Kokap", sumber: "Bidang PAUD-Dikmas Internal", jenjang: "PAUD/PNF", izin: "Izin Aktif (Valid)", akreditasi: "B", prestasi: "Apresiasi Parenting Komunitas Desa", inovasi: "Bina Keluarga Balita", statusColor: "emerald" },
    { npsn: "20402840", nama: "SMP Negeri 3 Girimulyo", kapanewon: "Girimulyo", sumber: "Dapodik & Data Dikpora", jenjang: "SMP", izin: "Negeri (Aktif)", akreditasi: "B", prestasi: "Juara Harapan Konservasi Lingkungan", inovasi: "Sekolah Adiwiyata Menoreh", statusColor: "emerald" },
    { npsn: "20402825", nama: "SD Negeri Samigaluh 2", kapanewon: "Samigaluh", sumber: "Dapodik & Data Dikpora", jenjang: "SD", izin: "Negeri (Aktif)", akreditasi: "B", prestasi: "Juara 3 Seni Budaya Tradisional DIY", inovasi: "Kelas Seni Kesenian Lokal", statusColor: "emerald" },
    { npsn: "69834120", nama: "PKBM Mandiri Kalibawang", kapanewon: "Kalibawang", sumber: "Bidang PAUD-Dikmas Internal", jenjang: "PAUD/PNF", izin: "Izin Aktif (Valid)", akreditasi: "B", prestasi: "Sentra Vokasi Kopi Menoreh", inovasi: "Pelatihan Wirausaha Terapan", statusColor: "purple" },
    { npsn: "20402860", nama: "SMP Negeri 1 Lendah", kapanewon: "Lendah", sumber: "Dapodik & Data Dikpora", jenjang: "SMP", izin: "Negeri (Aktif)", akreditasi: "A", prestasi: "Juara 2 Pramuka Garuda Kulon Progo", inovasi: "Sekolah Ramah Anak", statusColor: "emerald" },
    { npsn: "20402865", nama: "SD Negeri Galur 1", kapanewon: "Galur", sumber: "Dapodik & Data Dikpora", jenjang: "SD", izin: "Negeri (Aktif)", akreditasi: "A", prestasi: "Finalis Literasi Sekolah DIY", inovasi: "Pojok Baca Digital", statusColor: "emerald" },
    { npsn: "20402845", nama: "SMP Negeri 1 Panjatan", kapanewon: "Panjatan", sumber: "Dapodik & Data Dikpora", jenjang: "SMP", izin: "Negeri (Aktif)", akreditasi: "A", prestasi: "Juara 1 Lomba Drumband Pelajar", inovasi: "Pendidikan Karakter Maritim", statusColor: "emerald" },
    { npsn: "20402850", nama: "SMP Negeri 1 Nanggulan", kapanewon: "Nanggulan", sumber: "Dapodik & Data Dikpora", jenjang: "SMP", izin: "Negeri (Aktif)", akreditasi: "A", prestasi: "Juara 1 Debat Bahasa Kulon Progo", inovasi: "Laboratorium Riset Terbuka", statusColor: "purple" }
  ]
};
